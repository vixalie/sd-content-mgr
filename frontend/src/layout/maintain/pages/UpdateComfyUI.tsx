...
import { useUpdateComfyUI } from './states/update-comfyui';

export const UpdateComfyUI: FC = () => {
  const settings: config.ComfyUIConfig = useLoaderData();
  const [
    remotes,
    selectedRemote,
    activeRemote,
